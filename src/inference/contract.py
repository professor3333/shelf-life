...
FIELDS: tuple[Field, ...] = (
    ...
    Field(
        ...
        False,
        (
            "how many postings the board carried at `t`. Unknowable from one posting; derived "
            "from a declared board snapshot in ranking mode"
        ),
    ),
    Field(
        "board_growth",
        ...
        (
            ...
            "derived in ranking mode from `previous_board_size`"
        ),
    ),
    Field(
        ...
        False,
        (
            "duplicate-title count on the board at `t`. Unknowable from one posting; derived "
            "from a declared board snapshot in ranking mode"
        ),
    ),
    Field(
        ...
        False,
        (
            "requisition-group size on the board at `t`. Unknowable from one posting; derived "
            "in ranking mode from `requisition_id`, when given"
        ),
    ),
)
