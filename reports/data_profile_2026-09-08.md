...
| Data | **real** · snapshot `2026-09-08` · `data/raw/2026-09-08/manifest.json` |
| Panel | 7,312 rows · sha256 `05c73713d92a…` |
| Code | `f8e3c4dd7` on `feature/reports-from-a-clean-tree` (clean) |
| Snapshot sha256 | `204d5aae1e78…` |
| Contents | 7,312 jobs · 29,464 observations · 122 runs |
