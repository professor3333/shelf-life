...
|---|---|---|---|---|---|
| 01-prior | does anything at all beat a constant? | 0.019 | 0.0172 | -0.0018 | 0.0018 |
| 02-logistic | is there linear signal in the allowed features? | 0.0174 | 0.2733 | 0.2558 | 0.114 |
| 03-random_forest | does non-linearity buy anything over the logistic fit? | 0.0193 | 1 | 0.9807 | 0.0881 |
| 04-xgboost_panel_native | boosting, on the features that existed before any were engineered | 0.0224 | 1 | 0.9776 | 0.0145 |
| 05-xgboost_engineered | do the seven engineered features earn their place? | 0.0226 | 1 | 0.9774 | 0.016 |
| 06-xgboost_leaky | what happens when a panel-wide observation count is admitted? | 0.029 | 1 | 0.971 | 0.0136 |
| 07-xgboost_leak_removed | and what is left once it is taken away again? | 0.0226 | 1 | 0.9774 | 0.016 |
| 08-xgboost_tuned | does tuning inside the training window buy anything? | 0.0226 | 1 | 0.9774 | 0.016 |
...
- run 05, honest features: **0.0226** validation PR-AUC
- run 06, leaky columns admitted: **0.0290**
- run 07, leaky columns removed: **0.0226**

The leak was worth **+0.0064** PR-AUC, and removing it returned
...
- git `2005aabaf5ae60870782f5d6463ec7687a9a0b6b` on `feature/first-real-ladder` — **dirty tree**
- panel `data/processed/features/job_days_h1_calendar.parquet`, 10,355 rows, sha256 `f9793cdcb01ed75dbbc5c32b3dd815996498b8794eb6268b43ef9f2d45a3eee9`
- snapshot `2026-09-08`
