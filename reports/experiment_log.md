...
|---|---|---|---|---|---|---|---|
| 01-prior | does anything at all beat a constant? | 0.0086 | 0.0089 | 0.0203 | 0.0134 | -0.0068 | 0.0068 |
| 02-logistic | is there linear signal in the allowed features? | 0.0325 | 0.0122 | 0.0269 | 0.1245 | 0.0975 | 0.2159 |
| 03-random_forest | does non-linearity buy anything over the logistic fit? | 0.2053 | 0.1245 | 0.0838 | 0.8452 | 0.7614 | 0.0859 |
| 04-xgboost_panel_native | boosting, on the features that existed before any were engineered | 0.1277 | 0.0872 | 0.0708 | 0.7096 | 0.6389 | 0.048 |
| 05-xgboost_engineered | do the seven engineered features earn their place? | 0.1409 | 0.1127 | 0.0713 | 0.8012 | 0.7299 | 0.0347 |
| 06-xgboost_leaky | what happens when a panel-wide observation count is admitted? | 0.269 | 0.1218 | 0.2398 | 0.9902 | 0.7505 | 0.0182 |
| 07-xgboost_leak_removed | and what is left once it is taken away again? | 0.1409 | 0.1127 | 0.0713 | 0.8012 | 0.7299 | 0.0347 |
| 08-xgboost_tuned | does tuning inside the training window buy anything? | 0.1974 | 0.1143 | 0.0705 | 0.9114 | 0.8409 | 0.0259 |
...
- run 05, honest features: **0.0713** validation PR-AUC
- run 06, leaky columns admitted: **0.2398**
- run 07, leaky columns removed: **0.0713**

The leak was worth **+0.1684** PR-AUC, and removing it returned
...
margin. The +0.1684 jump is a single observation that something changed when two
...
+0.1684 *attributable* rather than merely observed: without it I have a
...
0.0713 — a stochastic learner has no obligation to land on the same four
...
too well offline. The expected story is degradation: 0.2398 offline becomes
...
happens here is that it does not decay toward the honest 0.0713 — it stops
...
0.0182, against 0.0347 for the honest run. The only
...
- git `5e4e7a768d81e7598d8ddd4fcd22d63de15ec225` on `phase-7`
- panel `data/processed/features/job_days_h1_calendar.parquet`, 19,569 rows, sha256 `6dafb81f45815ed611d0ea912c319ae0da647bf6cafc1e750c31b5a72c738c2b`
- snapshot `2026-09-17`
