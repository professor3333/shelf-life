...
|---|---|---|---|---|---|---|---|
| 01-prior | does anything at all beat a constant? | 0.0077 | 0.0075 | 0.0203 | 0.0124 | -0.0079 | 0.0079 |
| 02-logistic | is there linear signal in the allowed features? | 0.0267 | 0.0153 | 0.0271 | 0.1207 | 0.0936 | 0.2191 |
| 03-random_forest | does non-linearity buy anything over the logistic fit? | 0.199 | 0.1024 | 0.11 | 0.9057 | 0.7957 | 0.075 |
| 04-xgboost_panel_native | boosting, on the features that existed before any were engineered | 0.1472 | 0.0853 | 0.0681 | 0.6895 | 0.6214 | 0.0436 |
| 05-xgboost_engineered | do the seven engineered features earn their place? | 0.0875 | 0.0154 | 0.0736 | 0.8001 | 0.7265 | 0.0334 |
| 06-xgboost_leaky | what happens when a panel-wide observation count is admitted? | 0.3378 | 0.1172 | 0.2472 | 0.99 | 0.7428 | 0.0183 |
| 07-xgboost_leak_removed | and what is left once it is taken away again? | 0.0875 | 0.0154 | 0.0736 | 0.8001 | 0.7265 | 0.0334 |
| 08-xgboost_tuned | does tuning inside the training window buy anything? | 0.1959 | 0.0986 | 0.0772 | 0.9086 | 0.8314 | 0.0222 |
...
- run 05, honest features: **0.0736** validation PR-AUC
- run 06, leaky columns admitted: **0.2472**
- run 07, leaky columns removed: **0.0736**

The leak was worth **+0.1736** PR-AUC, and removing it returned
...
margin. The +0.1736 jump is a single observation that something changed when two
...
+0.1736 *attributable* rather than merely observed: without it I have a
...
0.0736 — a stochastic learner has no obligation to land on the same four
...
too well offline. The expected story is degradation: 0.2472 offline becomes
...
happens here is that it does not decay toward the honest 0.0736 — it stops
...
0.0183, against 0.0334 for the honest run. The only
...
- git `36bdd499a70e9057eecc6932c22febe639bc182e` on `phase-7-readiness-safety`
- panel `data/processed/features/job_days_h1_calendar.parquet`, 20,724 rows, sha256 `f3046d5d39686ccee822b5b9f8d4c41d6b9b77f4d35a07909a3b20542e248a02`
- snapshot `2026-09-18`
