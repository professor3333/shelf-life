...
Generated by `python -m src.models.experiments` on H=1 (calendar basis) — a pipeline smoke test, not the build's horizon. Regenerate rather than edit.
...
- git `8a89f73468a982829d83bdda4b2cdac2bd4c990b` on `fix/a-categorical-that-is-numeric` — **dirty tree**
