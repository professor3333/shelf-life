...
## Relisting under a new posting id — 753 removal(s)
...
|---|---|---|---|
| `requisition_id` | 9/197 = 4.6% | 133/1087 = 12.2% | **below control** (-7.7% ± 3.6%) — relisting is *less* common among postings the label calls removed than among postings that stayed up |
| `title` | 24/202 = 11.9% | 154/1115 = 13.8% | **indistinguishable** (-1.9% ± 5.0%) — the difference does not clear twice its standard error, so this sample says nothing either way |
...
| source | 2026-08-31 | 2026-09-01 | 2026-09-02 | 2026-09-03 | 2026-09-04 | 2026-09-05 | 2026-09-06 | 2026-09-07 |
|---|---|---|---|---|---|---|---|---|
| greenhouse:anthropic | 50 | 46 | 33 | 44 | 43 | 49 | 47 | 45 |
| greenhouse:discord | 6 | 6 | 6 | 6 | 6 | 5 | 5 | 5 |
| greenhouse:duolingo | 4 | 3 | 3 | 8 | 7 | 9 | 9 | 9 |
| greenhouse:figma | 10 | 6 | 6 | 11 | 7 | 12 | 12 | 12 |
| greenhouse:gitlab | 24 | 21 | 16 | 31 | 26 | 27 | 27 | 27 |
| python_org | 0 | 4 | 4 | 5 | 4 | 4 | 2 | 1 |
...
|---|---|---|---|
| 1 run | 1260 | 107 | 0.0849 |
| 2 runs | 1240 | 94 | 0.0758 |
| 3 runs | 1174 | 77 | 0.0656 |
| 4-5 runs | 2315 | 197 | 0.0851 |
| 6+ runs | 3162 | 278 | 0.0879 |

Postings seen in fewer than 6 complete runs are 65.4% of labelled rows and carry **63.1% of all removals**: 7.9% against 8.8%, a factor of 1.
