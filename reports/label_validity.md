...
## Relisting under a new posting id — 1040 removal(s)
...
|---|---|---|---|
| `requisition_id` | 6/242 = 2.5% | 138/1132 = 12.2% | **below control** (-9.7% ± 2.8%) — relisting is *less* common among postings the label calls removed than among postings that stayed up |
| `title` | 13/249 = 5.2% | 167/1160 = 14.4% | **below control** (-9.2% ± 3.5%) — relisting is *less* common among postings the label calls removed than among postings that stayed up |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| greenhouse:anthropic | 50 | 46 | 33 | 44 | 43 | 49 | 47 | 45 | 46 | 34 | 29 |
| greenhouse:discord | 6 | 6 | 6 | 6 | 6 | 5 | 5 | 5 | 7 | 4 | 3 |
| greenhouse:duolingo | 4 | 3 | 3 | 8 | 7 | 9 | 9 | 9 | 9 | 5 | 5 |
| greenhouse:figma | 10 | 6 | 6 | 11 | 7 | 12 | 12 | 12 | 13 | 14 | 14 |
| greenhouse:gitlab | 24 | 21 | 16 | 31 | 26 | 27 | 27 | 28 | 35 | 32 | 29 |
| python_org | 0 | 4 | 4 | 5 | 4 | 4 | 2 | 1 | 3 | 2 | 2 |
...
|---|---|---|---|
| 1 run | 1323 | 109 | 0.0824 |
| 2 runs | 1296 | 95 | 0.0733 |
| 3 runs | 1178 | 77 | 0.0654 |
| 4-5 runs | 2386 | 199 | 0.0834 |
| 6+ runs | 6425 | 560 | 0.0872 |

Postings seen in fewer than 6 complete runs are 49.0% of labelled rows and carry **46.2% of all removals**: 7.8% against 8.7%, a factor of 1.
