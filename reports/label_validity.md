...
Generated by `python -m src.data.label_audit` on H=1 (calendar basis) — a pipeline smoke test, not the build's horizon. Regenerate rather than edit.
...
## Relisting under a new posting id — 533 closure(s)
...
|---|---|---|---|
| `requisition_id` | 15/194 = 7.7% | 128/1088 = 11.8% | **indistinguishable** (-4.0% ± 4.3%) — the difference does not clear twice its standard error, so this sample says nothing either way |
| `title` | 20/199 = 10.1% | 152/1117 = 13.6% | **indistinguishable** (-3.6% ± 4.7%) — the difference does not clear twice its standard error, so this sample says nothing either way |
...
|---|---|---|---|---|---|---|---|---|
| greenhouse:anthropic | 11 | 15 | 24 | 35 | 52 | 59 | 59 | 57 |
| greenhouse:discord | 0 | 0 | 4 | 2 | 4 | 3 | 3 | 3 |
| greenhouse:duolingo | 1 | 0 | 0 | 4 | 7 | 6 | 6 | 6 |
| greenhouse:figma | 4 | 0 | 4 | 6 | 3 | 3 | 3 | 3 |
| greenhouse:gitlab | 4 | 5 | 2 | 23 | 28 | 24 | 26 | 26 |
| python_org | 0 | 0 | 0 | 1 | 1 | 3 | 2 | 1 |
