...
| Code | `213a4a1f5` on `feature/pre-register-the-rest-of-the-evaluation` (dirty tree) |
...
## Relisting under a new posting id — 519 removal(s)
...
|---|---|---|---|
| `requisition_id` | 7/164 = 4.3% | 133/1086 = 12.2% | **below control** (-8.0% ± 3.7%) — relisting is *less* common among postings the label calls removed than among postings that stayed up |
| `title` | 19/169 = 11.2% | 154/1114 = 13.8% | **indistinguishable** (-2.6% ± 5.3%) — the difference does not clear twice its standard error, so this sample says nothing either way |
...
|---|---|---|---|---|---|---|
| greenhouse:anthropic | 50 | 46 | 33 | 44 | 43 | 33 |
| greenhouse:discord | 6 | 6 | 6 | 6 | 6 | 5 |
| greenhouse:duolingo | 4 | 3 | 3 | 8 | 7 | 4 |
| greenhouse:figma | 10 | 6 | 6 | 11 | 7 | 7 |
| greenhouse:gitlab | 24 | 21 | 16 | 31 | 26 | 20 |
| python_org | 0 | 4 | 4 | 5 | 4 | 4 |
...
|---|---|---|---|
| 1 run | 1258 | 107 | 0.0851 |
| 2 runs | 1217 | 92 | 0.0756 |
| 3 runs | 1124 | 73 | 0.0649 |
| 4-5 runs | 2212 | 183 | 0.0827 |
| 6+ runs | 987 | 64 | 0.0648 |

Postings seen in fewer than 6 complete runs are 85.5% of labelled rows and carry **87.7% of all removals**: 7.8% against 6.5%, a factor of 1.
