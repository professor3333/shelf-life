...
Yes. The newest crawl is `2026-09-14 03:48Z`, 0 days 07:30:13.901803 old against a cadence of 0 days 23:59:58.980213 — within tolerance, so the projections below are meaningful.
...
|---|---|---|---|---|
| a legal three-way split | 22 | 8 | 14 | 2026-09-28 |
| 3 rolling-origin folds | 34 | 8 | 26 | 2026-10-10 |

At H=7 the embargo is 9 days 13:43:51.653374 against a cadence of 0 days 23:59:58.980213, so each of the two block boundaries discards 10 wave(s), and the newest 1 labelled wave(s) cannot carry a positive at all — a removal needs the posting absent from two consecutive later runs.
