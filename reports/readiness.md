...
| Code | `28c7ef6bf` on `phase-7` (clean) |
...
Yes. The newest crawl is `2026-09-17 03:48Z`, 0 days 03:34:52.759808 old against a cadence of 1 days 00:00:00.249016 — within tolerance, so the projections below are meaningful.
...
|---|---|---|---|---|
| a legal three-way split | 22 | 10 | 12 | 2026-09-29 |
| 3 rolling-origin folds | 34 | 10 | 24 | 2026-10-11 |

At H=7 the embargo is 9 days 13:43:51.653374 against a cadence of 1 days 00:00:00.249016, so each of the two block boundaries discards 10 wave(s), and the newest 1 labelled wave(s) cannot carry a positive at all — a removal needs the posting absent from two consecutive later runs.
