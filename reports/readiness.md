...
| Code | `b788fbee6` on `main` (dirty tree) |
...
**No — and this is the finding.** The newest crawl in the panel is `2026-09-08 03:48Z`, 2 day(s) old against an observed cadence of 1 days 00:00:03.564294. About 2 wave(s) have not arrived.
...
|---|---|---|---|---|
| a legal three-way split | 20 | 2 | 18 | **not projected** — the panel is not accruing |
| 3 rolling-origin folds | 31 | 2 | 29 | **not projected** — the panel is not accruing |

At H=7 the embargo is 8 days 10:21:37.132005 against a cadence of 1 days 00:00:03.564294, so each of the two block boundaries discards 9 wave(s), and the newest 1 labelled wave(s) cannot carry a positive at all — a closure needs the posting absent from two consecutive later runs.
