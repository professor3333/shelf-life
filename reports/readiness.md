...
| Panel | 12,675 rows · sha256 `584b43d6ce28…` |
| Code | `f86c24969` on `feature/read-the-log-the-collector-writes` (dirty tree) |
...
Yes. The newest crawl is `2026-09-11 04:23Z`, 0 days 07:16:30.355619 old against a cadence of 1 days 00:00:03.564294 — within tolerance, so the projections below are meaningful.
