...
**PR-AUC is the headline.** Accuracy is not reported: at a base rate of 0.0132, predicting "stays open" for every posting scores 98.7% and has told you nothing.

**ROC-AUC is reported but not decisive.** With rare positives it flatters. The
false-positive rate divides by the true-negative count — 5,618 of them against 75
