...
**PR-AUC is the headline.** Accuracy is not reported: at a base rate of 0.0124, predicting "stays open" for every posting scores 98.8% and has told you nothing.

**ROC-AUC is reported but not decisive.** With rare positives it flatters. The
false-positive rate divides by the true-negative count — 7,937 of them against 100
